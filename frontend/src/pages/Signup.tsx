    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <div className="retro-panel" style={{ width: '100%', maxWidth: '420px', padding: '2rem' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            <label className="retro-label">DISPLAY_NAME</label>
            <input
              type="text"
              value={displayName}
          ...
          <div>
            <label className="retro-label">PASSWD (min 6 chars)</label>
            <input
              type="password"
              value={password}
        ...
        <div style={{ borderTop: '1px solid var(--green-dark)', marginTop: '1.25rem', paddingTop: '1rem', textAlign: 'center', fontSize: '0.78rem', color: 'var(--green-dim)' }}>
          ALREADY REGISTERED?{' '}
          <Link to="/login" style={{ color: 'var(--green)', textDecoration: 'none', borderBottom: '1px solid var(--green-dim)' }}>
            ACCESS TERMINAL
          </Link>
        </div>
      </div>
